...
static TranslationEntry translations[] = {
  ...
  { FALSE, "org.gnome.desktop.a11y.interface", "keyboard-focus-visible-timeout", "gtk-keyboard-focus-visible-timeout", G_TYPE_INT, { .i = -1 } },
  ...
  switch (entry->type)
    ...
    case G_TYPE_ENUM:
      if (strcmp (entry->key, "font-rendering") == 0)
        ...
        entry->fallback.i = (int) (g_variant_get_uint32 (value) + 1);
      else if (strcmp (entry->key, "reduced-motion") == 0)
