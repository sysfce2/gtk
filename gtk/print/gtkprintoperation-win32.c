 ...
 * (otherwise libgtk3 manifest only affects libgtk3 itself).
 ...
 */
static void
win32_load_dll_with_visual_style_manifest (const char *dll_name)
{
  ...
  if (g_once_init_enter (&common_controls_initialized))
    {
      ...
      win32_load_dll_with_visual_style_manifest ("comdlg32.dll");
