...
PASS(0) vec2 _pos;
PASS(1) flat Rect _rect;
PASS(2) flat vec4 _blur_color;
PASS(3) vec2 _tex_coord;
PASS(4) flat vec2 _tex_blur_step;
PASS(5) flat uint _samples_per_side;
PASS(6) flat uint _tex_id;
PASS(7) flat vec3 _initial_gaussian;
