...
static void
gsk_gl_image_find_gl_format (GdkMemoryFormat  format,
                             GdkMemoryFormat *out_format,
                             GLuint          *out_gl_internal_format,
                             GLuint          *out_gl_format,
                             GLuint          *out_gl_type,
                             GLint            out_swizzle[4])
{
                             ...
                             gsize           height)
{
  ...
  gsk_gl_image_find_gl_format (format,
                               &format,
                  ...
                  gsize           height)
{
   ...
   */
  if (swizzle[0] != GL_RED || swizzle[1] != GL_GREEN || swizzle[2] != GL_BLUE)
    {
